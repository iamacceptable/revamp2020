    ...
    <div class="contact-info">
        <div class="container">
            <div class="contact__tittle">
                <h1>Login as Participant</h1>
            </div>
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="contact-info__item-left wow fadeInLeft">
                        <img src="<?= base_url();?>assets/images/kec_log.png">
                    </div>
                </div>
            
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="contact-info__item-left wow fadeInRight">
                    <h4>Enter the ceredentials:</h4>
                    <div class="fillin-form">
                        <form action="<?= base_url()?>Registration/login" method="POST">
                            <?php if(isset($error)){?>
                                <label style="color: red;"><?= $error;?></label>
                            <?php } ?>
                            <div class="fillin-form__fields"> 
                                <input required type="number" placeholder="*Mobile Number" name="mobile" value="<?= set_value('mobile');?>"><br>
                                <label style="color: red; "><?= form_error('mobile');?></label>
                            </div>
                            <div class="fillin-form__fields"> 
                                <input value="<?= set_value('password');?>" required type="password" placeholder="*Password" name="password">
                            ...
                            <div class="fillin-form__submit">
                                ...
                                <input class="moving-btn" type="submit" value="Login">
                            </div>
                        </form>
                        <br><br>
                    </div>
