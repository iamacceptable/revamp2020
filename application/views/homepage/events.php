        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-4 col-sm-12">
                <div class="experience__text">
                    <h1>Events</h1>
                    <p>Transforming an ordinary day into an event with capturing magical moments for life to hold the day forever.</p>
                    <div class="link-draw__hover">
                        ...
                        <a class="experience__text__link" href="#">Discover more</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-sm-6">
